...
const websocketEndpoint = document.getElementById("websocket-url");
const websocketConnectButton = document.getElementById("websocket-connect-button");
...
function logStaticMessage(message, source) {
